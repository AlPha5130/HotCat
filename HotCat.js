...
( function ( $, mw ) {
	...
	var HC = window.HotCat = {
		...
		messages: {
			cat_removed: '移除了[[Category:$1]]',
			template_removed: '移除了{{[[Category:$1]]}}',
			cat_added: '添加了[[Category:$1]]',
			cat_keychange: '将[[Category:$1]]的键更改为“$2”', // $2 is the new key
			cat_notFound: '没有找到分类“$1”',
			cat_exists: '分类“$1”已经存在，将不会添加。',
			cat_resolved: '（已解析重定向[[Category:$1]]）',
			uncat_removed: '移除了{{uncategorized}}',
			separator: '，',
